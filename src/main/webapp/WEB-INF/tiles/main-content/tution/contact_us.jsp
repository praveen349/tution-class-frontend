		...
		<div class="right-common-content">
			<div class="row contact-row">
						...
						<div class="form-group">
							<div class="col-sm-7">
								<div class="input-group margin-bottom-sm">
									...
									</span> <input id="Name" name="contactus_name" ng-model="sender.name"
						...
						<div class="form-group">
							<div class="col-sm-7">
								<div class="input-group margin-bottom-sm">
									...
									</span> <input id="Mobile" name="contactus_number" ng-model="sender.mobile"
										class="form-control input-xlarge  validate[required]"
						...
						<div class="form-group">
							<div class="col-sm-7">
								<div class="input-group margin-bottom-sm">
									...
									</span> <input id="Email" name="contactus_email" ng-model="sender.email"
							...
							<div class="col-sm-7">
								<div class="input-group margin-bottom-sm">
									...
									<textarea rows="3" id="Message" name="contactus_message"
										class="form-control input-xlarge  validate[required]"
										ng-model="sender.msg" placeholder="Message"></textarea>
								</div>
							</div>
						</div>
				...
				<div class="col-xs-6 col-md-6 contact-details">
					...
					<div class="row">
						<div>
							Kolkata Tution Bureau.<br /> # 12/2, NC Mitra Road, Third Floor,<br />
							Near Dumdum Cantonment Railway station,<br /> kollata-700028,<br />
							West Bengal, India.
